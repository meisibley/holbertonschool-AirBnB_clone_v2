...
def odd_or_even(n):
    '''display a HTML page and show an odd or even number'''
    if n % 2 == 0:
        return render_template('6-number_odd_or_even.html', num=n, ooe='even')
    else:
        return render_template('6-number_odd_or_even.html', num=n, ooe='odd')
